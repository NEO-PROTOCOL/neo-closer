...
```bash
Linha 3:  WOOVI_WEBHOOK_SECRET=openpix_o2jGDXpNroajMCRm/uSS7UUD9vES4HiDpFgj36R75sA=
Linha 10: WOOVI_WEBHOOK_SECRET=openpix_o2jGDXpNroajMCRm/uSS7UUD9vES4HiDpFgj36R75sA=
```
...
```bash
# 1. WOOVI_API_KEY
Q2xpZW50X0lkXzk2MDRkYTJmLTQ0N2EtNGJjMi1iNjYxLWQwNzBlOGNjNWVkZTpDbGllbnRfU2VjcmV0X0g5M3ZsbEsrTjNvSWJ0bEFkVWJ1T0hDbExUano5WWRiNmpTNHlORzVsaU09

# 2. WOOVI_WEBHOOK_SECRET
openpix_o2jGDXpNroajMCRm/uSS7UUD9vES4HiDpFgj36R75sA=

# 3. JWT_SECRET (MESMO valor do FLOWPAY_JWT_SECRET)
6efddab08745069cd6157087ef8a3b01c6343dd3da7754b311180045b8855423c2c28d2a69c0893b52ff0c1344ac87cf15c2daa7d1a58f4971226e59296f0ed8
```
